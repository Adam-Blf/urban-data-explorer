...
ALL_SOURCES: list[SourceSpec] = [
    ...
    SourceSpec(
        ...
        family="mobilite",
        catalog_url="https://data.iledefrance-mobilites.fr/explore/dataset/accessibilite-des-gares-et-stations-du-reseau-idfm/",
        download_url="https://data.iledefrance-mobilites.fr/api/explore/v2.1/catalog/datasets/accessibilite-des-gares-et-stations-du-reseau-idfm/exports/csv?limit=-1",
        provider="IDFM / data.iledefrance-mobilites.fr",
        separator=";",
        geo_point_column="geopoint",
        arrondissement_candidates=("code_postal",),
        address_candidates=("nom_gare",),
    ),
    ...
    SourceSpec(
        ...
        title="Universites, grandes ecoles et CPGE en Ile-de-France",
        family="vie_quotidienne",
        catalog_url="https://data.enseignementsup-recherche.gouv.fr/explore/dataset/fr-esr-cartographie_etablissements-esr/",
        download_url="https://data.enseignementsup-recherche.gouv.fr/api/explore/v2.1/catalog/datasets/fr-esr-cartographie_etablissements-esr/exports/csv?limit=-1&where=reg_id%3D%2211%22&timezone=UTC&use_labels=false",
    ...
    SourceSpec(
        ...
        title="Accessibilite PMR des ERP Paris - acceslibre (beta.gouv.fr)",
        family="vie_quotidienne",
        catalog_url="https://www.data.gouv.fr/fr/datasets/accessibilite-des-etablissements-recevant-du-public/",
        download_url="https://www.data.gouv.fr/fr/datasets/r/eb0bfa16-1a32-4bde-b8a0-c8e4e9bfd4cb",
        provider="acceslibre / beta.gouv.fr / data.gouv.fr",
        separator=";",
        latitude_candidates=("latitude",),
        longitude_candidates=("longitude",),
        arrondissement_candidates=("code_postal",),
